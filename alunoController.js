...
async function Inserir(req, res) {
  try {
    ...
    await serviceAluno.Inserir(matricula, nome, sobrenome, turma, login, email, senha);
...
async function Editar(req, res) {
  try {
    ...
    const result = await serviceAluno.Editar(matricula, nome, sobrenome, turma, login, email, senha);
